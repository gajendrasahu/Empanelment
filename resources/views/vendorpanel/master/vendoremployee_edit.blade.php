...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{ route('update.vendoremployee',$data->vendorid)}}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<div class="col-sm-12 bg-danger" style="padding:10px; font-size:14px;">
							<i class="fa fa-info-circle"></i> SINCE THIS EMPLOYEE ACCOUNT HAS BEEN VERIFIED BY THE SCREW DRIVER. YOU CAN NOT EDIT ANY DETAILS. PLEASE CONTACT THE SCREW DRIVER SUPPORT TEAM. THANKS
						</div>
					</div>
					...
					<div class="col-sm-9">
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="name" id="name" value="{{old('name',$data->name)}}" placeholder="{{__('labels.employeename')}}" autofocus autocomplete="off" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" />
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="aadharnumber" id="aadharnumber" value="{{old('aadharnumber',$data->aadhaarnumber)}}" placeholder="{{__('labels.aadharnumber')}}" required autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
