				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						<div class="col-sm-12 bg-danger" style="padding:10px; font-size:14px;">
							<i class="fa fa-info-circle"></i> SINCE YOUR ACCOUNT HAS BEEN VERIFIED. YOU CAN NOT EDIT ANY DETAILS. PLEASE CONTACT YOUR VENDOR. THANKS
						</div>
					</div>
					...
					<div class="col-sm-9">
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="aadharnumber" id="aadharnumber" value="{{old('aadharnumber',$data->aadharnumber)}}" placeholder="{{__('labels.aadharnumber')}}" required autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
