			...
			<form id="frmVendorInvoice" enctype="multipart/form-data">
				...
				<div class="card">
					...
					<div class="card-header">
						<strong class="font-16">Vendor Invoice Details</strong>
					</div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="myheadbg no_wrap">GST on CHiPS Administrative Charges</td>
...
function calculateVendorPayment()
{
	...
	var netPayment = Math.round((approvalAmount - tdsAmount - gstTdsAmount) * 100) / 100;
