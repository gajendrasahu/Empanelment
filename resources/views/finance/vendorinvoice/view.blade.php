							...
							<div class="card mb-3">
								...
								<div class="card-header" style="position:relative;">
									...
									<strong class="bg-primary padding-5" style="width:100%!important;">
										...
										Approved Amount : <span class="format-indian" data-value="{{ number_format($mpr->mpr_approved_value,'2','.','') }}"></span> INR
									</strong>
...
$(document).on('click','.btnVerifyInvoice',function()
{
	...
	bootbox.confirm(
		...
		function(result)
		{
			...
			verifyVendorInvoice(voucherId,button,finance_remarks);
		}
	);
});


function verifyVendorInvoice(voucherId,button,finance_remarks)
{
	$.ajax({
