	...
	<table style="width:100%;">
		...
		<tr>
			...
			<td style="float:right; vertical-align:top;" nowrap>
				...
				Receipt Date : {{date('d\-m\-Y h:i A',strtotime($receiptdate))}}
			</td>
		</tr>
		<tr>
			<td colspan="2" style="vertical-align:top;">
				<table class="table">
					...
					<tr>
						...
						<td class="height" style="text-align:left; padding:0px 2px;">
							<b>Acknowledgment:</b><br>
							We acknowledge the receipt of the payment made towards the wallet recharge. Thank you for your prompt payment. Best regards, The Screw Driver
						</td>
						<td class="height" style="text-align:right; padding:0px 2px;">{{ number_format($amount,'2','.','') }}</td>
					</tr>
				</table>
			</td>
		</tr>
