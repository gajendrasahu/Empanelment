			...
			<td colspan="2" style="vertical-align:top;">
				<table class="table">
					...
					<tr class="height">
						...
						<td class="total height">{{ number_format($order->netpayable,'2','.','') }}</td>
					</tr>
