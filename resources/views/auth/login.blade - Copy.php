                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h4 class="blue" id="id-company-text">{{ __('common.companyname') }}<br><br>{{ __('loginform.loginwindowmessage') }}</h4>                             
                            </div>
    ...
    <fieldset>
        <label class="block clearfix">
            <span class="block input-icon input-icon-right">
                <input type="text" name="UserName" :value="old('UserName')" id="UserName" class="form-control" placeholder="Username / Registered Email" required />                
