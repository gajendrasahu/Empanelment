...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{route('add.deptcommittee')}}" method="post" enctype="multipart/form-data">
				@csrf
				...
				<div class="form-group">
							...
							<div class="content-detail">
								...
								<div class="ui-card-detail">
									...
									<a href="{{route('update.confirm',Crypt::encrypt($data->requestid))}}" style="">
								...
								<div class="ui-card-detail lh-25">
									<div>
										<div class="title-detail">
									...
									@if($data->eoistatus<3)
									<a href="{{route('update.eoidetail',Crypt::encrypt($data->requestid))}}" style="position:absolute; bottom:5px; right:5px;">
										<button type="button" class="btn btn-info padding-0-5">
								...
								<div class="section-block-detail font-14">
								...
								@include('admin.viewpages.other_without_editor')
								...
								<div class="section-block-detail">
									...
									<div class="grid-layout-detail cols-4" style="padding:0px 0px; gap:0px;">
										<table style="text-transform:none!important; width:100px; margin-top:5px;">
											<tr>
												<td>
												<input type="hidden" name="requestid" id="requestid" value="{{Crypt::encrypt($data->requestid)}}">												
													<select class="select2 form-control" name="memberid" id="memberid" required onKeyPress="return OnKeyPress(this, event)"  data-placeholder="Member Name" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" data-width="250">
														<option value=""></option>
												...
												<td>
													<button type="button" style="text-transform:none!important; margin-left:10px;" class="btn btn-info myfrmbtn submitCommitteeBtn" tabindex="{{$t++}}"><i class="fa fa-plus"></i> Add Committee Member</button>
												</td>
											</tr>
										</table>
										...
										<tr style="text-transform: none!important;">
											...
											@if($data->isupdated==0)
												...
												@else
													...
													@else
													<h5><i class="fa fa-hand-o-right"></i> The Expression of Interest (EoI) has been published and is open for firm participation.</h5>
													@endif
												@endif
											@else
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if(result)
				{
					...
					$.ajax({
						url: '{{route("generate_confirmation_otp")}}',
						type: 'POST',
						data: formData,
						processData: false,
						contentType: false,
...
$('#verifyOtp').click(function (e) {
	...
	formData.append('_token', '{{ csrf_token() }}');
	$.ajax({
		url: '{{route("verify_confirmation_otp")}}',
		type: 'POST',
		data: formData,
		processData: false,
		contentType: false,
