...
@if($data)
	...
	<tr class="mytr" id="item-{{ $r }}">
		...
		<td class="mytd v-top padding-10 center" nowrap><i class="fa fa-trash" onclick="deleteEois('deleteeois','{{ Crypt::encrypt($rec->recordid) }}',{{$r}},'{{ __('messages.confirmation') }}','{{ __('messages.deleted') }}')" title=""></i>
...
<tr>
	...
	<td class="padding-5"><b>{{$totalmanmonth}}</b></td>
...
@if($tier2==1)
<tr>
	<td class="padding-10 form-label tier-choice-cell" colspan="10">
