...
<div class="tabbable animated fadeInUp delay-02" style="padding:0px 0px!important;">
		@if(in_array(2,Session::get('actions')) || in_array(3,Session::get('actions')) || in_array(12,Session::get('actions')))
			<div class="eoi-section-header" onclick="loadData(1,'{{ route('deptinvoicehistory.html') }}')"
...
<div id="recordlist" class="tab-pane in active" style="padding:0px 0px!important;">
	<div class="row" style="padding:0px;">
		...
		<div class="col-xs-12">
		<form name="add_payment" id="add_payment" action="{{route('add.invoicepayment')}}" method="post">
			@csrf
			<div class="table-responsive">
				...
				<tr>
					...
					<div class="table-filters-row">
						...
						<select name="pagesize" id="pagesize" class="select2" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}')" data-width="95" data-placeholder="RECORDS">
							<option value="300">300</option>
							<option value="500">500</option>
							<option value="1000">1000</option>
						</select>
						<select class="select2" name="mpr_month" id="mpr_month" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}');" data-width="120" data-placeholder="Month">
							<option value=""></option>
						...
						<select class="select2" name="mpr_year" id="mpr_year" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}');" data-width="100" data-placeholder="Year">
							<option value=""></option>
						...
						<select class="select2" name="vendor_id" id="vendor_id" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}');" data-placeholder="Firm Name" data-width="150">
							<option value=""></option>
						...
						<select class="select2" name="payment_status" id="payment_status" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}');" data-placeholder="Status" data-width="150">
							<option value=""></option>
						...
						<span class="input-icon">
							<input type="text" placeholder="Search ..." class="nav-search-input selectbx" id="pagesearch" name="pagesearch" autocomplete="off" onchange="loadData(1,'{{ route('deptinvoicehistory.html') }}')" tabindex="<?php echo $t++;?>" />
...
$(document).ready(function() {
	...
	loadData(1,'{{ route('deptinvoicehistory.html') }}');
