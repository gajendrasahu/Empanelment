		...
		<ul class="nav nav-tabs padding-0">
			<li class="active form-label font-14">
				<a data-toggle="tab" href="#home">
					<i class="green ace-icon fa fa-times bigger-120 datalist" style="vertical-align:text-top;"></i>Cancel EoI
				</a>
			</li>
		</ul>
...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{route('store.cancellation')}}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						Cancellation remark <label id="req">*</label>
						...
						<textarea class="form-control" name="cancellation_remark" id="cancellation_remark" placeholder="Cancellation reason...">{{old('cancellation_remark')}}</textarea>
						
						<span class="text-danger">@error('cancellation_remark') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
					</div>
					<div class="col-sm-12">&nbsp;</div>
					<div class="col-sm-12">&nbsp;</div>
					<div class="col-sm-4">
						Attach File <label id="req">&nbsp;</label>
						<input type="file" class="form-control" name="cancellation_attachment" id="cancellation_attachment" accept=".pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>						
						<span class="text-danger">@error('cancellation_attachment') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
					</div>
					
					<div class="col-sm-6">&nbsp;</div>
					<div class="col-sm-2" align="left">
						<button type="submit" class="btn btn-info myfrmbtn" tabindex="{{$t++}}" style="text-transform:none!important;">
							<i class="fa fa-save icon-animated-bell"></i> Submit
						</button>
					</div>
					<div class="col-sm-12">&nbsp;</div>
				</div>		
...
jQuery(function($) {	
	...
	$('#cancellation_attachment').ace_file_input({
		no_file:'No File ...',
