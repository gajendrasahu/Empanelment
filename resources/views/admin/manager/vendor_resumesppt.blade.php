					...
					<div class="content-detail">
						...
						<div class="section-block-detail">
							...
							<table class="mytable" border="1" style="text-transform: capitalize!important;">
								...
								@if($eoi->categoryid==2)
								<tr class="myheadbg">
									<td class="mytd form-label padding-10" nowrap style="position:relative;">{{$index+1}}) Sector : {{ucwords(strtolower($req->sectorname))}} | Position : {{$req->consultantposition}} | Experience <i class="fa fa-info-circle" title="As per empanelment"></i> : {{$req->experience}} | Duration : {{$req->duration}} Months
								...
								@if($req->remark)
								<tr>
									<td class="mytdwhite padding-10" style="width:20px;">Remark : {!!$req->remark!!}</td>
								</tr>
								@endif
							...
							<table class="" style="text-transform: none!important; margin-top:20px; width:100%;">
								...
								<tr>
									<td class="padding-0 right">
										<a href="{{ route('view.pmpptresumes',Crypt::encrypt($eoi->requestid))}}">
