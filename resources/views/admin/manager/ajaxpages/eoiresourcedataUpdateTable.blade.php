  ...
  $('.info-icon').each(function () {
    ...
    let html =
      '<table>' +
        ...
        '<tr><td nowrap class="padding-5 text-left">Tax (B=A+(A*' + tax + '%))</td>' +
    ...
    // Set HTML content in Bootstrap 3
    $(this)
      .attr('data-original-title', html)  // key fix
      .tooltip({
        html: true,
        placement: 'auto',
        container: 'body'
...
// Format numbers in the main table
document.querySelectorAll('.format-indian').forEach(function(el) {
    el.innerText = formatIndianNumber(el.dataset.value);
});

// Format numbers inside tooltip when shown
