...
<head>
    ...
    <title>Draft Expression of Interest (EoI)</title>
...
<body>
    <div class="container">
        ...
        <div class="requirements-section">
			...
			@if($eoidata->categoryid==2)
			{!!$tier1_html!!}
			{!!$tier2_html!!}
			@endif


			@if($eoidata->categoryid==1)
			{!!$tier1_html!!}
			{!!$tier2_html!!}

			@endif
        </div>
        @if($eoidata->projectobjective!='')
        <div class="content-section">
            <div class="content-header">Project Objective</div>
            <div class="content-body">
			{!!$eoidata->projectobjective!!}
            </div>
        </div>
		@endif
        <!-- About Project Section -->
		@if($eoidata->aboutproject!='')
        <div class="content-section">
            <div class="content-header">About Project</div>
            <div class="content-body">
			{!!$eoidata->aboutproject!!}
            </div>
        </div>
        @endif
        <!-- Scope Of Work Section -->
		@if($eoidata->scopeofwork!='')
        <div class="content-section">
		...
		@if($eoidata->anyother!='')
        <div class="content-section">
            <div class="content-header">Special Conditions (If Any)</div>
            <div class="content-body">
                {!!$eoidata->anyother!!}
            </div>
        </div>
		...
		@if($eoidata->evaluationprocess!='')
        <div class="content-section">
            <div class="content-header">Evaluation Process</div>
            <div class="content-body">
                {!!$eoidata->evaluationprocess!!}
            </div>
        </div>
		@endif
		@if($eoidata->termsandcondition!='')
        <div class="content-section">
            <div class="content-header">Payment & Penalty Terms</div>
            <div class="content-body">
                {!!$eoidata->termsandcondition!!}
            </div>
        </div>
		@endif
		@if($eoidata->criticalinformation!='')
        <div class="content-section">
            <div class="content-header">Critical Information</div>
            <div class="content-body">
                {!!$eoidata->criticalinformation!!}
            </div>
        </div>
		@endif
		
		@if($eoidata->documentrequired!='')
        <div class="content-section">
            <div class="content-header">Documents Required To Participate In This EoI</div>
            <div class="content-body">
                {!!$eoidata->documentrequired!!}
            </div>
        </div>
        @endif
        <!-- Conditions Section -->
