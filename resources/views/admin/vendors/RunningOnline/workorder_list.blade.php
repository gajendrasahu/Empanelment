...
<div class="tabbable animated fadeInUp delay-02" style="padding:0px 0px!important;">
		@if(in_array(2,Session::get('actions')) || in_array(3,Session::get('actions')) || in_array(12,Session::get('actions')))
			<div class="eoi-section-header" onclick="loadData(1,'{{ route('vendororderlist.html') }}')"
			...
			<div class="table-responsive">
				...
				<tr>
					<td colspan="7" class="padding-5">
						...
						<select name="pagesize" id="pagesize" class="select2" onchange="loadData(1,'{{ route('vendororderlist.html') }}')" data-width="90" data-placeholder="RECORDS">
							<option value="50">50</option>
							<option value="100">100</option>
							<option value="300">300</option>
							<option value="500">500</option>														
						</select>
						<select class="select2" name="departmentid" id="departmentid" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('vendororderlist.html') }}');" data-width="300" data-placeholder="Department / Project Manager">
							<option value=""></option>
						...
						<select class="select2" name="subuserid" id="subuserid" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('vendororderlist.html') }}');" data-width="200" data-placeholder="Sub User">
							<option value=""></option>
						...
						<select name="is_expired" id="is_expired" class="select2" onchange="loadData(1,'{{ route('vendororderlist.html') }}')"  data-width="175" data-placeholder="All Order">
						...
						<span style="position:absolute; right:30px; top:10px;">
						  <input type="checkbox" name="is_cancelled" id="is_cancelled" onchange="loadData(1,'{{ route('vendororderlist.html') }}')" style="vertical-align:text-top;">
				...
				<tr>
					<td colspan="7" class="padding-5">
						<span class="input-icon" style="width:100%!important;">
							<input type="text" placeholder="Search ..." class="nav-search-input " id="pagesearch" name="pagesearch" autocomplete="off" onchange="loadData(1,'{{ route('vendororderlist.html') }}')" style="width:100%!important;" tabindex="<?php echo $t++;?>" />
				...
				<tr><td colspan="7" class="center padding-6">--Search Record--</td></tr>
				</tbody>
				</table>
			</div>
		</form>
...
$(document).ready(function() {
	...
	loadData(1,'{{ route('vendororderlist.html') }}');
});
