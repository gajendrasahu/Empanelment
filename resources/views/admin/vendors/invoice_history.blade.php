	...
	<div class="row" style="padding:0px;">
		...
		<form name="pagedata" id="pagedata" action="#" method="post" onsubmit="return false;">
			...
			<div class="table-responsive">
				...
				<tr>
					<td colspan="4">
						<select class="select2" name="order_id" id="order_id" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('invoicehistory.html') }}');" data-width="100%" data-placeholder="Project Name">
							<option value=""></option>
							@foreach ($orders as $itm)
							<option value="{{ $itm->orderid }}">{{ $itm->project_name }}</option>
							@endforeach
						</select>
				...
				<tr>
					...
					<div id="tablehead">
						...
						<select class="select2" name="subuserid" id="subuserid" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('invoicehistory.html') }}');" data-width="250" data-placeholder="Created By">
							<option value=""></option>
