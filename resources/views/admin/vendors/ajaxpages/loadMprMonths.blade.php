...
<div class="form-label font-16" style="line-height:30px;">
	...
	<div class="">You have submitted all your MPRs. There are no pending MPRs to submit at this time.</div>
</div>
</span>
...
$(".modal-title").html('<i class="fa fa-file-text-o"></i> Project Name - <b>{{$order->project_name}}</b> | Order Date : <b>{{date('d\-m\-Y',strtotime($order->orderdate))}}</b> | Work Order Due Date : <b>{{date('d\-m\-Y',strtotime($order->workorderduedate))}}</b>');
@else
