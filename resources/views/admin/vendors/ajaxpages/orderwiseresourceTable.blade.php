...
<table class="order-table pd-8">
    ...
    <!-- ORDER SUMMARY -->
    <tr>
        <td colspan="@if($rec->categoryid==2) 7 @else 6 @endif" class="order-summary">
    ...
    <tr class="resource-row">
        ...
        <td style="padding:0px!important; width:100px!important;" class="text-center">
			...
			@elseif($resource->deployment_status=='Active' || $resource->deployment_status=='Pending')
				<button type="button" class="btn btn-success gridbtn" style="padding:4px; height:35px; border:none!important; background-color:#147E8B!important;" onclick="viewResourceDetail('{{route('view.resourcedetail',Crypt::encrypt($resource->deploymentid))}}')">View & Update</button>
