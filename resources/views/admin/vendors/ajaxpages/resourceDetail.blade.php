...
<form name="updateResourceDetail" id="updateResourceDetail" action="{{route('vendorresource.update',Crypt::encrypt($resource->deploymentid))}}" method="post" enctype="multipart/form-data">
@csrf
...
@if($resource->deployment_status=='Active')
<a href="{{ route('workordervendor.replaceresource', Crypt::encrypt($resource->deploymentid)) }}" style="float:left;">
...
@if($resource->deployment_status=='Active')
<a href="{{ route('workordervendor.replaceresource', Crypt::encrypt($resource->deploymentid)) }}" style="float:left;">
<button type="button" class="btn btn-info gridbtn" style="width:150px;" data-bs-dismiss="modal">
	<i class="fa fa-refresh"></i> Replace Resource
</button>
</a>
@endif
