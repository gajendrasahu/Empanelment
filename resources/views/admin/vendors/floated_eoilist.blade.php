...
<div class="tabbable animated bounceInUp" style="padding:0px 0px!important;">
		...
		@if(in_array(2,Session::get('actions')) || in_array(3,Session::get('actions')) || in_array(12,Session::get('actions')))
			<li @if(!in_array(1,Session::get('actions'))) class="active" @endif>
				<a class="form-label" data-toggle="tab" href="#recordlist" onclick="loadData(1,'{{ route('floatedeoi.html') }}')">
					<i class="green ace-icon fa fa-list bigger-120 datalist" style="vertical-align:bottom;"></i> Published EoI
				</a>
			</li>
		@endif
		</ul>
			...
			<div class="table-responsive">
				...
				<tr>
					<td class="padding-8">
						...
						<select name="pagesize" id="pagesize" class="select2" onchange="loadData(1,'{{ route('floatedeoi.html') }}')" data-width="100">							
							<option value="100">100</option>
							<option value="300">300</option>
							<option value="500">500</option>														
						</select>
						
						<select class="select2" name="departmentid" id="departmentid" onKeyPress="return OnKeyPress(this, event)" onchange="loadData(1,'{{ route('floatedeoi.html') }}');" data-width="350" data-placeholder="Department / Project Manager">
							<option value=""></option>
						...
						<span class="input-icon">
							<input type="text" placeholder="Search ..." class="nav-search-input" id="pagesearch" name="pagesearch" autocomplete="off" onchange="loadData(1,'{{ route('floatedeoi.html') }}')" tabindex="<?php echo $t++;?>" />
