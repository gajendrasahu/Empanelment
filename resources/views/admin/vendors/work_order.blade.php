						...
						<div class="ui-card-detail">
							<div>
								...
								<div class="details-detail">
									...
									Please review the details below for confirmation.
								</div>
							</div>
						</div>
						...
						<div class="ui-card-detail">
							<div>
								...
								<table class=""  style="text-transform: none!important;">
									<tr>
										<td class="padding-10 font-bold">Vendor Name</td>
									...
									<tr>
										<td class="padding-10 font-bold">Note Sheet</td>
										<td class="padding-10" style="position:relative;">
								<a href="{{ route('view.uploadedfile',Crypt::encrypt($order->notesheet))}}" style="position:absolute; left:10px; top:10px;" target="_blank" class="action-a">
									<span class="label label-white middle animated flipInX delay-02 f-s-10 form-label span-content">
										<i class="fa fa-file-pdf-o"></i> View Note Sheet
									</span>
								</a>
										</td>
									</tr>
								...
								<a href="{{ route('view.uploadedfile',Crypt::encrypt($order->signedcopy))}}" style="position:absolute; left:10px; top:10px;" target="_blank">
									<span class="label label-white middle animated flipInX delay-02 f-s-10 form-label span-content">
										<i class="fa fa-file-pdf-o"></i> Order Signed Copy
									</span>
								</a>
										</td>
									</tr>
