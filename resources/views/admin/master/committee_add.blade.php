...
<ul class="nav nav-tabs padding-0">
	@permission('store.committeemember')
	<li class="active">
		<a data-toggle="tab" href="#home">
			<i class="green ace-icon fa fa-plus-circle bigger-120" style="vertical-align:bottom;"></i>Add Committee Member
		</a>
	</li>
	@endpermission
	@permission('committeemember.html')
	<li>
		<a data-toggle="tab" href="#recordlist" onclick="loadData(1,'{{ route('committeemember.html') }}')">
			<i class="green ace-icon fa fa-list bigger-120 datalist" style="vertical-align:bottom;"></i> Committee Member List
		</a>
	</li>
	@endpermission
</ul>
							<div class="tab-content no-border"
								style="border:1px solid #ddd; min-height:100px; padding:0px 10px;">
									...
									<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
										<div class="row">
											<div class="row">
												<form name="frm" id="frm" action="{{ route('store.committeemember', 0)}}"
													...
													<div class="table-responsive">
														<table class="table table-bordered table-striped table-hover pd-8"
															...
															<thead>
																	...
																	<td colspan="8">
																		<div id="tablehead">
																			<select name="pagesize" id="pagesize"
																				class="select2"
																				onchange="loadData(1,'{{ route('committeemember.html') }}')">
																...
																<tr class="myhead">
																	<td style="width:25px;" nowrap><b>{{ __('labels.sno') }}</b>
																	</td>
	...
	<script>
@if(app(\App\Services\PermissionService::class)->hasPermission('committeemember.html') && !app(\App\Services\PermissionService::class)->hasPermission('store.committeemember'))		
