							...
							<ul class="nav nav-tabs padding-0">
								@if(in_array(1, Session::get('actions')))
									<li class="active"><a data-toggle="tab" href="#home"><i
												...
												style="vertical-align:bottom;"></i>Add Category </a></li>
								@endif
								@if(in_array(2, Session::get('actions')) || in_array(3, Session::get('actions')) || in_array(12, Session::get('actions')))
									<li @if(!in_array(1, Session::get('actions'))) class="active" @endif><a data-toggle="tab"
											href="#recordlist" onclick="loadData(1,'{{ route('jobcategory.html') }}')"><i
												class="green ace-icon fa fa-list bigger-120 datalist"
												style="vertical-align:bottom;"></i> Category List</a></li>
								@endif
							</ul>
							...
							<div class="tab-content no-border"
								...
								@if(in_array(1, Session::get('actions')))
									<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
										<div class="row">
											<div class="row">
												<form name="frm" id="frm" action="{{ route('store.jobcategory', 0)}}"
													...
													<div class="form-group">
														...
														<div class="col-sm-3">
															...
															<input type="text" class="form-control" name="jobcategory"
																id="jobcategory" value="{{old('jobcategory')}}"
																placeholder="Category" autofocus required autocomplete="off"
																onKeyPress="return OnKeyPress(this, event)"
																tabindex="{{$t++}}" />

															<span class="text-danger">@error('jobcategory') <i
																class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i>
															@enderror</span>
														</div>

														<div class="col-sm-2 float-btn" align="left">
																	...
																	<td colspan="5">
																		<div id="tablehead">
																			<select name="pagesize" id="pagesize" class="select2"
																				onchange="loadData(1,'{{ route('jobcategory.html') }}')">
