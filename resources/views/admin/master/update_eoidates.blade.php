		...
		@if(in_array(1,Session::get('actions')))
			<li class="active">
				<a data-toggle="tab" href="#home" class="form-label">
					<i class="green ace-icon fa fa-calendar bigger-120 datalist" style="vertical-align:text-top;"></i> Update EoI Important Dates
				</a>
			</li>
		@endif
		</ul>
...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
			<form name="frm" id="frm" action="{{ route('eoi.updatedates',Crypt::encrypt($data->requestid))}}" method="post" enctype="multipart/form-data">
				@csrf
						...
						<div class="section-block-detail">
							...
							<div class="grid-layout-detail cols-2">
								...
								<div class="ui-item-detail">
									...
									<input type="text" name="releasedate" id="releasedate" class="todays_dt_hidden" placeholder="dd-mm-YYYY" required value="{{ old('releasedate',$data->releasedate ? date('d-m-Y',strtotime($data->releasedate)) : '') }}" style="width:350px;">
								...
								<div class="ui-item-detail">
									...
									<div class="input-group" style="width:350px;">
									<input type="text" name="prebidlastdate" id="prebidlastdate" class="todays_dt_hidden" placeholder="dd-mm-YYYY" required value="{{ old('prebidlastdate',$data->prebidlastdate ? date('d-m-Y',strtotime($data->prebidlastdate)) : '') }}" style="width:350px;">
									<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
								...
								<div class="ui-item-detail">
									...
									<div class="input-group" style="width:350px;">
									<input type="text" name="deadlinedate" id="deadlinedate" class="interview_date" placeholder="dd-mm-YYYY hh:mm AM/PM" required value="{{ old('deadlinedate', $data->deadlinedate ? date('d-m-Y h:i A', strtotime($data->deadlinedate)) : '') }}" style="width:350px;">
									<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
								...
								<div class="ui-item-detail">
									...
									<input type="text" name="interviewdate" id="interviewdate" class="interview_date" placeholder="dd-mm-YYYY hh:mm AM/PM" required value="@if($data->interviewdate!='' && $data->interviewdate!='1970-01-01'){{ old('interviewdate',$data->interviewdate ? date('d-m-Y h:i A',strtotime($data->interviewdate)) : '') }}@endif" style="width:350px;">
...
Chief Executive Officer&#10;Chhattisgarh Infotech Promotion Society (CHiPS)&#10;State Data Centre Building, Near Police Control Room, Civil Lines, Raipur, Chhattisgarh-492001<br>Tel : 91771-404158<br>Email : ceochips@nic.in, empl.chips@cgchips.in									
							...
							@if($data->eoistatus>=2 && $data->isordered==0)
							<button type="button" style="float:right;" class="btn btn-info myfrmbtn width-100 update-btn">Update</button><br><br><br>
							@endif
						</div>
