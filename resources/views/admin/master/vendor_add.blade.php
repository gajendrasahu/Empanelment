				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="col-sm-12">
							...
							<input type="file" class="form-control" name="profilepic" required id="profilepic" accept="image/*" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
					...
					<div class="col-sm-9">
						<div class="col-sm-4">
							...
							<input type="text" class="form-control firstname" name="name" id="name" value="{{old('name')}}" placeholder="{{__('labels.name')}}" autofocus autocomplete="off" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" />
						...
						<div class="col-sm-4">
							...
							@endif
							@if(old('stateid')=='')
							<select class="chosen-select form-control" required name="cityid" id="cityid" onKeyPress="return OnKeyPress(this, event)"  data-placeholder="{{__('labels.cityname')}}" onchange="GetAreaNames(this.value,'{{ route('areanames.list') }}')" tabindex="{{$t++}}">
								<option value=""></option>
							</select>
							@else
							@php
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="aadhaarnumber" required id="aadhaarnumber" value="{{old('aadhaarnumber')}}" placeholder="{{__('labels.aadharnumber')}}" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="pannumber" required id="pannumber" value="{{old('pannumber')}}" placeholder="{{__('labels.pannumber')}}" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						...
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="drivinglicence" required id="drivinglicence" value="{{old('drivinglicence')}}" placeholder="UPLOAD DRIVING LICENCE" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						...
						<div class="col-sm-2">
							...
							<input type="file" class="form-control" required name="aadhaarfrontfile" id="aadhaarfrontfile" accept="image/*, application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						...
						<div class="col-sm-2">
							...
							<input type="file" class="form-control" required name="aadhaarbackfile" id="aadhaarbackfile" accept="image/*, application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						...
						<div class="col-sm-4">
							...
							<input type="file" class="form-control" name="panfile" required id="panfile" accept="image/*, application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
							<span class="text-danger">@error('panfile') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
						</div>
						<div class="col-sm-4">
							UPLOAD LICENCE <label id="req">(MAX : 500 KB)*</label>
							<input type="file" class="form-control" name="licencefile" required id="licencefile" accept="image/*, application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
					...
					<div class="col-sm-3">
						...
						<input type="text" class="form-control" name="bankname" required id="bankname" value="{{old('bankname')}}" placeholder="{{__('labels.bankname')}}" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>

						<span class="text-danger">@error('bankname') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
					</div>
					<div class="col-sm-2">
						ACCOUNT NUMBER<label id="req">*</label>
						<input type="text" class="form-control" name="accountnumber" required id="accountnumber" value="{{old('accountnumber')}}" placeholder="ACCOUNT NUMBER" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
					...
					<div class="col-sm-2">
						...
						<input type="text" class="form-control" name="ifsccode" required id="ifsccode" value="{{old('ifsccode')}}" placeholder="{{__('labels.ifsccode')}}" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
					...
					<div class="col-sm-3">
						Bank File <label id="req">(MAX : 500 KB)*</label>
						<input type="file" class="form-control" name="bankfile" required id="bankfile" accept="image/*, application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
						<span class="text-danger">@error('bankfile') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
					</div>
...
<option value="{{ $itm->categoryid }}" @if(is_array(old('categoryid')) && in_array($itm->categoryid, old('categoryid'))) selected @endif>{{ strtoupper($itm->category) }}</option>
					...
					<div class="col-sm-3">
						...
						<select class="form-control" name="verificationstatus" id="verificationstatus" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}">
							<option value="1" @if(old('isselfemployeed')=='1') {{ 'selected' }} @endif>VERIFIED</option>
							<option value="0" @if(old('isselfemployeed')=='0') {{ 'selected' }} @endif>UN VERIFIED</option>
						</select>
			...
			<div class="table-responsive">			
				...
				<tr>
					...
					<div id="tablehead">
						...
						<select class="select2" name="actstatus" id="actstatus" onKeyPress="return OnKeyPress(this, event)"  data-placeholder="VERIFICATION STATUS" onchange="loadData(1,'{{ route('vendor.html') }}')" data-width="170">
							<option value=""></option>
				...
				<tr>
					...
					<button type="button" class="btn btn-info selectbx pull-right no-hover" style="width:100px;" onclick="exportData(1,'{{ route('exportvendor.html') }}')"><i class="fa fa-download"></i> Export Data</button>
					</td>
				</tr>
				</thead>
...
{
	bootbox.confirm('ARE YOU SURE YOU WANT TO VERIFY THIS VENDOR?<br><br>ONCE VERIFIED, THIS ACTION CANNOT BE UNDONE.',function(result){
		if(result)
		{
			$.get(""+r1,
			{
			...
			function(data, status){
				...
				setTimeout(function() { loadData(1,'{{ route('vendor.html') }}'); },5000);
			});
		}
	});
}
...
function exportData(page,r1)
{
    ...
    link.href = url;
    link.download = "exported_data.csv"; // The default file name for the CSV
    link.click();
