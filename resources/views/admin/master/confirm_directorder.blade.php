						...
						<div class="ui-card-detail">
							<div>
								...
								<div class="details-detail">
									The order has been successfully issued to the selected firm.<br>
								</div>
							</div>
						</div>
						...
						<div class="ui-card-detail">
							<div>
								...
								<table class=""  style="text-transform: none!important;">
									<tr>
										<td class="padding-10 font-bold">Order Number</td>
										<td class="padding-10">{{$order->ordernumber}}</td>
									</tr>
									<tr>
										<td class="padding-10 font-bold">Firm Name</td>
										<td class="padding-10">{{$order->companyname}}</td>
									</tr>
									<tr>
										<td class="padding-10 font-bold">Address</td>
										<td class="padding-10">{{$order->officelocation}}</td>
									</tr>
									@if($order->signedcopy)
									<tr>
