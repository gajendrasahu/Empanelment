...
@endphp
@php
    $canAutoOpen = app(\App\Services\PermissionService::class)->hasPermission('projectmanager.html') && !app(\App\Services\PermissionService::class)->hasPermission('store.projectmanager');
@endphp
...
@permission('store.projectmanager')
<li class="active">
	<a data-toggle="tab" href="#home">
		<i class="green ace-icon fa fa-plus-circle bigger-120" style="vertical-align:bottom;"></i> Add Project Manager
	</a>
</li>
@endpermission
@permission('projectmanager.html')
<li @if($canAutoOpen) class="active" @endif>
	<a data-toggle="tab" href="#recordlist" onclick="loadData(1,'{{ route('projectmanager.html') }}')">
		<i class="green ace-icon fa fa-list bigger-120 datalist" style="vertical-align:bottom;"></i> Project Manager
	</a>
</li>
@endpermission								
							</ul>
							...
							<div class="tab-content no-border"
								style="border:1px solid #ddd; min-height:100px; padding:0px 10px;">
									...
									<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
										<div class="row">
											<div class="row">
												<form name="frm" id="frm" action="{{ route('store.projectmanager', 0)}}"
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															...
															<input type="text" class="form-control" name="name" id="name"
																value="{{old('name')}}" placeholder="Enter project manager name"
														...
														<div class="col-sm-4">
															<label class="field-label">
																Mobile Number <span class="req">(login id)*</span>
															</label>
														...
														@permission('store.projectmanager')
														<button type="submit" class="btn btn-info myfrmbtn width-100" tabindex="{{$t++}}">
															Submit
														</button>
														@endpermission
														</div>
														...
														<table class="table table-bordered table-striped table-hover pd-8"
															...
															<thead>
																	...
																	<td colspan="6">
																		<div id="tablehead">
																			<select name="pagesize" id="pagesize"
																				...
																				onchange="loadData(1,'{{ route('projectmanager.html') }}')"
																...
																<tr class="myhead">
																	...
																	<td nowrap><b>Name & Official Email</b></td>
															...
															<tbody class="tabledata">
																<tr>
																	<td colspan="6" class="center">--Search Record--</td>
																</tr>
															</tbody>
														</table>
													</div>
