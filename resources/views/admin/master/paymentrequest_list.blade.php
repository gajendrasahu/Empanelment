				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="tabbable animated bounceInUp" style="padding:0px 0px!important;">
							@if(in_array(2, Session::get('actions')) || in_array(3, Session::get('actions')) || in_array(12, Session::get('actions')))
								<div class="eoi-section-header" onclick="loadData(1,'{{ route('orders.html') }}')"
									...
									<div style="font-size:14px; color:#6c757d; margin:2px 0px; 8px 0">
										Raise payment requests against orders and keep balances and approvals moving smoothly.
									</div>
					...
					<div class="filters-group">
																			<select name="pagesize" id="pagesize"
																				...
																				onchange="loadData(1,'{{ route('orders.html') }}')"
																...
																<tr>
																	...
																	<td class="width-200">Department Name</td>
																	<td nowrap>Order Number & Vendor Name</td>
																	<td nowrap class="center width-100">Order Date</td>
																	<td nowrap style="text-align:right;">Order Amount (in Rs.)
																	</td>
																	<td nowrap style="text-align:right;">Requested Amount</td>
																	<td nowrap style="text-align:right;">Paid Amount</td>
																	<td nowrap style="text-align:right;">Balance</td>
																</tr>
															</thead>
															<tbody class="tabledata">
																<tr>
																	<td colspan="8" class="center">--Search Record--</td>
																</tr>
															</tbody>
														</table>
													</div>
