...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
			...
			<form name="replacementfrm" id="replacementfrm" action="{{route('store.replaceresource',Crypt::encrypt($deployment->deploymentid))}}" method="post" enctype="multipart/form-data">
						...
						<div class="section-block-detail">
							...
							<table class="mytable" border="1" style="text-transform: none!important;">
								<tr class="myheadbg">
									...
									<td class="padding-10 font-bold" nowrap>Employee Code</td>
