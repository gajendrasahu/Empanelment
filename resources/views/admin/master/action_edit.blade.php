		...
		<ul class="nav nav-tabs padding-0">
			<li class="active">
				<a data-toggle="tab" href="#home">
					<i class="green ace-icon fa fa-plus-circle bigger-120" style="vertical-align:bottom;"></i> {{ __('labels.updateaction') }}
				</a>
			</li>
		</ul>
...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{ route('update.action',$data->actionid)}}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-sm-3">
						...
						<input type="text" class="form-control" name="actionname" id="actionname" value="{{old('actionname',$data->actionname)}}" placeholder="ACTION NAME" autofocus autocomplete="off" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
