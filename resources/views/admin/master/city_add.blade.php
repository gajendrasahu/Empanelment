...
<div class="tabbable" style="padding:0px 0px!important;">
		...
		@if(in_array(1,Session::get('actions')))
			<li class="active"><a data-toggle="tab" href="#home"><i class="green ace-icon fa fa-plus-circle bigger-120" style="vertical-align:bottom;"></i> {{__('labels.addcity')}}</a></li>
		@endif
		@if(in_array(2,Session::get('actions')) || in_array(3,Session::get('actions')) || in_array(12,Session::get('actions')))
			<li @if(!in_array(1,Session::get('actions'))) class="active" @endif><a data-toggle="tab" href="#recordlist" onclick="loadData(1,'{{ route('city.html') }}')"><i class="green ace-icon fa fa-list bigger-120 datalist" style="vertical-align:bottom;"></i> {{__('labels.citylist')}}</a></li>
		@endif
		</ul>
...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{ route('store.city',0)}}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-sm-3">
						...
						<select class="chosen-select form-control" name="stateid" id="stateid" autofocus required onKeyPress="return OnKeyPress(this, event)"  data-placeholder="{{__('labels.statename')}}" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}">
							<option value=""></option>
					...
					<div class="col-sm-3">
						...
						<input type="text" class="form-control ctname" name="cityname" id="cityname" value="{{old('cityname')}}" placeholder="{{__('labels.cityname')}}"  autocomplete="off" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" maxlength="50"/>
						
						<span class="text-danger">@error('cityname') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
					</div>
					<div class="col-sm-2">
						CITY CODE <label id="req">*</label>
						<span id="charCounter">0/50</span>
						<input type="text" class="form-control distname" name="aliasname" id="aliasname" value="{{old('aliasname')}}" placeholder="{{__('labels.aliasname')}}" required autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" maxlength="5"/>
		...
		<form name="pagedata" id="pagedata" action="#" method="post" onsubmit="return false;">
			<div class="table-responsive">			
				...
				<tr>
					<td colspan="6">
					<div id="tablehead">
						<select name="pagesize" id="pagesize" class="selectbx" onchange="loadData(1,'{{ route('city.html') }}')">
							<option value="100">100</option>
							<option value="300">300</option>
							<option value="500">500</option>														
						</select>
						<select class="select2" name="stid" id="stid" onKeyPress="return OnKeyPress(this, event)"  data-placeholder="STATE NAME" onchange="loadData(1,'{{ route('city.html') }}')">
							<option value=""></option>
							@foreach ($state as $itm)
						...
						<span class="input-icon" style="float:right;">
							<input type="text" placeholder="Search ..." class="nav-search-input" id="pagesearch" name="pagesearch" autocomplete="off" onchange="loadData(1,'{{ route('city.html') }}')" tabindex="<?php echo $t++;?>" />
				...
				<tr class="myhead">
					...
					<td nowrap style=""><b>CITY CODE</b></td>
