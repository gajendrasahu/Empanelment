		...
		@if(in_array(1,Session::get('actions')))
			<li class="active">
				<a data-toggle="tab" href="#home" class="form-label font-14">
					<i class="green ace-icon fa fa-plus-circle bigger-120 datalist" style="vertical-align:text-top;"></i> Add Payment Transaction
...
<div id="home" class="tab-pane in active" style="padding:0px 10px!important;">
	<div class="row">
		<div class="row">
			<form name="frm" id="frm" action="{{ route('receive.demandnotepayment',Crypt::encrypt($paymentid))}}" method="post" enctype="multipart/form-data">
				@csrf
					...
					<div class="content-detail">
						<div class="section-block-detail">
							<div class="section-header-detail">
								&nbsp;<h2 class="section-title-detail"><i class="fa fa-bars"></i> Add Payment Detail</h2>
							</div><br>
							...
							<table class="table table-bordered font-14" border="1" style="text-transform:none!important; width:500px;">
								<tr>
									...
									<td class="padding-10">{{$payment->demandnotenumber}}</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Demand Note Amount</td>
									<td class="padding-10">{{$payment->demandnoteamount}}</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Amount Received</td>
									<td class="padding-10">
										<input type="text" readonly name="received" id="received" value="{{$payment->total_received}}" style="width:100%;">
									</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Balance Amount</td>
									<td class="padding-10">
										<input type="text" readonly name="balanceamount" id="balanceamount" value="{{old('balanceamount',$payment->balance)}}" style="width:100%;">
									</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Paying Amount*</td>
									<td class="padding-10">
										<input type="text" required class="numbers" name="paying" id="paying" value="{{old('paying')}}" style="width:100%;" placeholder="0" autocomplete="off" tabindex="{{$t++}}">
									</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Transaction Detail*</td>
									<td class="padding-10">
										<input type="text" name="transactiondetail" id="transactiondetail" placeholder="Transaction detail" onKeyPress="return OnKeyPress(this, event)" required tabindex="{{$t++}}" style="width:100%;" autocomplete="off" value="{{old('transactiondetail')}}">
									</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Transaction File*</td>
									<td class="padding-10">
										<input type="file" required name="paymentfile" id="paymentfile" accept="application/pdf" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" data-width="200" style="width:150px!important;" />
									</td>
								</tr>
								<tr>
									<td class="padding-10 v-middle">Payment Period (in months)*</td>
									<td class="padding-10">
										<select name="paymentperiod" id="paymentperiod" required onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}" style="width:100%;">
								...
								<tr>
									...
									<td class="padding-10">
										<input type="text" name="payment_date" id="payment_date" class="todays_dt" onKeyPress="return OnKeyPress(this, event)" required tabindex="{{$t++}}" style="width:100%;" autocomplete="off" value="{{old('payment_date')}}">
									</td>
								</tr>
								<tr>
