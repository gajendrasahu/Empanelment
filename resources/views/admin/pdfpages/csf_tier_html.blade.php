...
<table class="mytable" border="1" style="text-transform: none!important;">
	<thead>
	<tr><td class="padding-5" colspan="6">Resource Details According to Tier -@if($pricing->tierid==1) 1 @else 2 @endif</td></tr>
	<tr class="">
	...
	<tr class="">
		...
		<td class="padding-5">{{$detail->experience}}</td>
	...
	<tr><td class="padding-5 v-top">Qualification :</td><td class="padding-5" colspan="5">{!! preg_replace('/ style="[^"]*"/i', '', $detail->qualification) !!}</td></tr>
	@endif
	@if($detail->remark!='')
	<tr><td class="padding-5 v-top">Remark :</td><td class="padding-5" colspan="5">{!! preg_replace('/ style="[^"]*"/i', '', $detail->remark) !!}</td></tr>
	@endif
...
<table class="mytable table-bordered table-striped" border="1" style="text-transform: none!important;">
	<thead>
	<tr><td class="padding-5" colspan="6">Resource Details According to Tier -@if($pricing->tierid==1) 1 @else 2 @endif</td></tr>
	<tr class="">
		<td class="padding-5 center" style="width:50px;">S.No.</td>
		<td class="padding-5" nowrap>Sector & Position</td>
		<td class="padding-5 width-300">Experience</td>
	...
	@if($detail->qualification!='')
	<tr><td class="padding-5 v-top" nowrap>Qualification :</td><td class="padding-5 font-13" colspan="5">{!! preg_replace('/ style="[^"]*"/i', '', $detail->qualification) !!}</td></tr>
	@endif
	@if($detail->remark!='')
	<tr><td class="padding-5 v-top" nowrap>Remark :</td><td class="padding-5 font-13" colspan="5">{!! preg_replace('/ style="[^"]*"/i', '', $detail->remark) !!}</td></tr>
	@endif
