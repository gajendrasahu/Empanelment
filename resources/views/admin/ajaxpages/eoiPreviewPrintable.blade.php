...
html, body, table, td, th, p, span, div {
    font-size: 14px;
}
html, body {
    width: 210mm;
...
4014158<br>Email: ceochips@nic.in				
			...
			<h3 style="font-size:30px;">Expression of Interest (EoI)</h3>
			<span style="font-weight:550; line-height:25px;">{{$data->projecttitle}}</span>
			</div>
		</td>
		<td style="width:10%;">
...
<table style="width:100%; border-collapse:collapse; margin-top:10px;" border="1">
	...
	@foreach($html as $row)
		<tr>
			<td colspan="2" style="padding:0px;">{!! $row !!}</td>
		</tr>
	@endforeach				
