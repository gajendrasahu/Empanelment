...
<tr class="mytr" id="item-{{ $i }}">
	...
	@if(in_array(2,Session::get('actions')))
		<a href="{{ route('edit.expensehead',$item->headid) }}" title="" class="myactionlink"><i class="fa fa-edit"></i></a></td>
	@endif
    <td nowrap style="text-align:center;">
	@if(in_array(3,Session::get('actions')))
        <a title="" class="myactionlink" onclick="deleteItem('expensehead',{{ $item->headid}},{{ $i }},'ARE YOU SURE YOU WANT TO DELETE THIS RECORD?','EXPENSE HEAD NAME DELETED SUCCESSFULLY')" title=""><i class="fa fa-trash"></i>
        </a>
	@endif
    </td>
</tr>
...
paginationLinks.forEach(link => {
	link.onclick = function(event) {
		...
		const url = '{{ route('expensehead.html') }}'; // URL generated by Laravel route
