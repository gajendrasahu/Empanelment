...
<tr class="mytr" id="item-{{ $i }}">
	...
	@if(in_array(2,Session::get('actions')))
		<a href="{{ route('edit.sector',Crypt::encrypt($item->sectorid)) }}" title=""><i class="fa fa-edit"></i></a></td>
	@endif
    <td nowrap style="text-align:center;">
	@if(in_array(3,Session::get('actions')))
        <a title="" onclick="deleteItem('sector','{{ Crypt::encrypt($item->sectorid) }}',{{ $i }},'{{ __('messages.confirmation') }}','{{ __('messages.deleted') }}')" title=""><i class="fa fa-trash"></i>
        </a>
	@endif
    </td>
</tr>
...
const paginationLinks = document.querySelectorAll('.pagination a');
        paginationLinks.forEach(link => {
            link.onclick = function(event) {
                ...
                const url = '{{ route('sector.html') }}'; // URL generated by Laravel route
