...
@if($paymentmode=='CASH')
<div class="col-sm-2">
	PAYMENT DATE <label id="req">*</label>
	<input type="date" class="form-control" name="paymentdate" id="paymentdate" required value="" autocomplete="off" onKeyPress="return OnKeyPress(this, event)" tabindex="{{$t++}}"/>
	<span class="text-danger">@error('paymentdate') <i class="fa fa-hand-o-right"> {{ strtoupper($message) }}</i> @enderror</span>
</div>
<div class="col-sm-2">
...
<div class="col-sm-2">
	BALANCE AMOUNT<label id="req">*</label>
	<input type="number" class="form-control" name="balanceamt" id="balanceamt" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" placeholder="Balance amount" readonly autocomplete="off" style="width:100%;"/>
</div>
...
<div class="col-sm-2">
	BALANCE AMOUNT<label id="req">*</label>
	<input type="number" class="form-control" name="balanceamt" id="balanceamt" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" readonly autocomplete="off" style="width:100%;" placeholder="Enter balanc amount"/>
</div>
<div class="col-sm-12">&nbsp;</div>
<div class="col-sm-10">
	REMARK IF ANY<label id="req">&nbsp;</label>
...
<div class="col-sm-2">
	BALANCE AMOUNT<label id="req">*</label>
	<input type="number" class="form-control" name="balanceamt" id="balanceamt" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" readonly autocomplete="off" placeholder="Balance amount" style="width:100%;"/>
</div>
<div class="col-sm-2">
	REMARK IF ANY<label id="req">&nbsp;</label>
	<input type="text" class="form-control" name="remark" id="remark" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" autocomplete="off" style="width:100%;" placeholder="Remark"/>
...
<div class="col-sm-2">
	BALANCE AMOUNT<label id="req">*</label>
	<input type="number" class="form-control" name="balanceamt" id="balanceamt" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" readonly autocomplete="off" style="width:100%;" placeholder="Balance amount"/>
</div>
<div class="col-sm-2">
	REMARK IF ANY<label id="req">&nbsp;</label>
	<input type="text" class="form-control" name="remark" id="remark" value="" onKeyPress="return OnKeyPress(this, event)" tabindex="<?php echo $t++;?>" autocomplete="off" style="width:100%;" placeholder="Remark"/>
