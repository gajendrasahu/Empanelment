...
<tr>
	...
	Please use the following One-Time Password (OTP) to proceed with the confirmation:<br>
	OTP: {{$otp}}<br><br>
	This OTP is valid for a limited time and is required to complete the proposal submission confirmation process. Please do not share this OTP with anyone for security reasons.<br><br>
