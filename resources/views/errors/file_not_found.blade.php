...
<head>
  ...
  <title>Invalid Access | CHiPS</title>
...
@csrf
    ...
    <div class="login-container">
		...
		<div class="login-as">File Not Found</div>
		<p><b>Oops!</b> The page you're looking for doesn't exist.</p>
		...
		<button type="button" class="submit-btn" onclick="window.close()">Back</button>
