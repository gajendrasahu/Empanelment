...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
		...
		\App\Http\Middleware\ValidateReferer::class,

    ];

//		\App\Http\Middleware\BlockScriptTags::class,
    /**
    ...
    protected $routeMiddleware = [
		...
		'jwt.validate'			=> \App\Http\Middleware\JWTMiddleware::class,
		...
		'pdf.security' 			=> \App\Http\Middleware\PdfUploadSecurity::class,
