...
{
    public function pmInvoiceList(Request $request)
	{
        Session::put('adminmenu','pmorderinvoices');
		Session::put('adminsubmenu','pminvoices');
       ...
       return view('admin/manager/invoice_history',compact('months','years','firms','token'));
		
    }

    public function getPmInvoiceData(Request $request)
	{
		...
		return view('admin/manager/ajaxpages/invoicehistoryTable', ['data' => $data]);
    }
